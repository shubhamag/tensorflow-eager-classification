...
def main():
    ...
    parser.add_argument('--eval-interval', type=int, default=250,
                        help='how many batches to wait before'
                             ' evaluate the model')
    parser.add_argument('--log-dir', type=str, default='06_mixup_tb',
        ...
        for (images, labels,weights) in tfe.Iterator(train_dataset):
            ...
            if(N%2 ==0 and mix_flag):
                ...
                with tf.GradientTape() as tape:
                    ...
                    loss_value = tf.losses.sigmoid_cross_entropy(mix_labels, mix_logits, mix_weights)
            ...
            if global_step.numpy() % args.log_interval == 0:
                ...
                with tf.contrib.summary.always_record_summaries():
                    ...
                    if(mix_flag):
                        tf.contrib.summary.image('Training images', mix_images)
                    else:
